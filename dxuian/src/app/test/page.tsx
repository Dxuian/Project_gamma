...
export function CardWithForm({src , content , title ,  username , timestamp}:{src:any; content : any ; title?:any ; username?:any ; timestamp?:any}) {
