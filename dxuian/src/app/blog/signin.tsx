...
export  function Signinreal({trigger}:{trigger:any}) {
  ...
  return (
    ...
    <div className="form-group">
      ...
      <div className="form-field">
        <div className="form-control">
          <span  id="signupopener" className="link link-underline-hover link-primary text-sm"  onClick={() => trigger(true)}>Don't have an account? 
